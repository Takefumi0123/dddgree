...
#define DIAMETER_LEFT		22.392				//左エンコーダ直径
#define DIAMETER_RIGHT		22.441				//右エンコーダ直径
#define PULSE_LEFT		100					//左エンコーダパルス
#define PULSE_RIGHT		100					//右エンコーダパルス
#define TREAD			228					//エンコーダ間距離
#define TURN_P_GAIN		3.5					//回転出力Pゲイン
#define TURN_D_GAIN		4					//回転出力Dゲイン
#define STRAIGHT_P_GAIN		0.8					//直進出力Pゲイン
#define STRAIGHT_D_GAIN		1					//直進出力Dゲイン
